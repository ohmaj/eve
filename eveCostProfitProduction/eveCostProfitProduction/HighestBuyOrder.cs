...
{
    public class HighestBuyOrder
    {
        public HighestBuyOrder()
        {

        }
        public double getHighestBuyOrder(StarSystem system, MarketOrders orders)
        {
            ...
            double ordersHighestBuyOrder = priceOfOrders.Max();
            return ordersHighestBuyOrder;
